...
module.exports = {
  ...
  onStart: async function ({ api, event, args }) {
    ...
    const userInfo = {
      ...
      location: "Sylhet",    // Replace with your location
      bio: "Bot & JavaScript Lover | Always Learning!", // Replace with your bio
      botName: "🕸️ 🅝🅔🅩🅤🅚🅞 🥷", // Replace with bot's name
    ...
    const imgurLinks = [
      "https://res.cloudinary.com/mahiexe/video/upload/v1747999382/mahi/1747999381874-320148484.mp4",  // Replace with actual Imgur video links
      "",
    ];
